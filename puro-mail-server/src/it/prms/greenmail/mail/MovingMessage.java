 ...
 */
package it.prms.greenmail.mail;


import it.prms.greenmail.foedus.util.Resource;
 ...
 * </p>
 */
public class MovingMessage { //(*) messaggio creato e gestito durante l'arrivo di una connessione, per poi essere salvato nella mailbox al termine delle operazioni
    MailAddress returnPath; //(*) from address
    ...
    public void setReturnPath(MailAddress fromAddress) { //(*) from address
