 ...
 */
public class SimpleStoredMessage //(*) classe messaggi salvati in HierarchicalFolder 
        implements StoredMessage {
    private MimeMessage mimeMessage;
    private Flags flags;
    private Date internalDate;
    private long uid;
    private SimpleMessageAttributes attributes; //(*) viene settato solo quando si fà getAttributes, quindi in realtà si potrebbe non usare un campo a parte e restituire direttamente un oggetto SimpleMessageAttributes nuovo ad ogni chiamata
