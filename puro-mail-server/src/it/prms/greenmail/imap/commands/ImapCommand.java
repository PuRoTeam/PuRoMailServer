...
import it.prms.greenmail.imap.ImapSessionState;
...
public interface ImapCommand {
     ...
     *
     * @param state The current {@link it.prms.greenmail.imap.ImapSessionState state} of the {@link it.prms.greenmail.imap.ImapSession}
