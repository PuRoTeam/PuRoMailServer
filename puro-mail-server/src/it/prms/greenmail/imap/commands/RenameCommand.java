...
class RenameCommand extends AuthenticatedStateCommand {
    ...
    protected void doProcess(ImapRequestLineReader request,
        ...
        session.getHost().renameMailbox(session.getUser(), existingName, newName); //(*) se rinomino INBOX (cartella speciale), sposto tutti i messaggi in una nuova cartella dal nome scelto, e lascio INBOX vuota (ma non la rimuovo)
