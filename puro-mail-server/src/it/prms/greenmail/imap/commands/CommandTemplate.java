 ...
 * core functionality useful for all {@link it.prms.greenmail.imap.commands.ImapCommand} implementations.
 *
...
abstract class CommandTemplate
     ...
     *
     * @see it.prms.greenmail.imap.commands.ImapCommand#validForState
     */
